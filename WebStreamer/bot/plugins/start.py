        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="Sorry Sir, You are Banned to use me. Contact me [Support](https://t.me/Biswa04).",
                        parse_mode="markdown",
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="Something went Wrong. Contact [Support](https://t.me/Biswa04).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton('Torrent Group', url='https://t.me/t2gbiswa'), InlineKeyboardButton('Support', url='https://t.me/Biswa04')]
                ]
            ),
            disable_web_page_preview=True
        )
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="Sorry Sir, You are Banned to use me. Contact [Support](https://t.me/Biswa04).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
        ...
        try:
            ...
            if user.status == "kicked":
                await bot.send_message(
                    ...
                    text="Sorry Sir, You are Banned to use me. Contact my [Support](https://t.me/Biswa04).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
